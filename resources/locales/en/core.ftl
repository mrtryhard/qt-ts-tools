...
cli-shell-completion-desc = Print a shell completion for supported shells.
...
open-or-parse-error = Could not open or parse input file "{ $file }". Reason: { $error }.
sort-parse-error = Could not parse input file "{ $input_path }". Reason: { $error }.
ts-error-write-output-open = Error occured while opening output file { $output_path }. Reason: { $error }.
ts-error-write-serialize = Problem occured while serializing output translation file. Reason: { $error }.
