...
## [1.1.0] 2026-09-10
This release is the [Twenty third milestone](https://github.com/mrtryhard/qt-ts-tools/milestone/23) milestone.
...
## [1.0.0] 2026-02-18
This release is the [Twenty second milestone](https://github.com/mrtryhard/qt-ts-tools/milestone/21) milestone.
...
## [0.10.0] 2025-12-08
[Twenty first milestone](https://github.com/mrtryhard/qt-ts-tools/milestone/22).  
...
## [0.9.1] 2025-08-26
[Eighteenth milestone](https://github.com/mrtryhard/qt-ts-tools/milestone/18).
This is a maintenance release and introduces an upgrade of dependencies.
...
## [0.9.0] 2025-07-26
[Seventeenth milestone](https://github.com/mrtryhard/qt-ts-tools/milestone/17).
This release is a breaking change release. The formatted XML output now avoids inserting whitespaces. 

### Changed

- Upgraded `clap` to version `4.5.41`
- Upgraded `clap_complete` to version `4.5.54`
- Upgraded `clap_nushell` to version `4.5.7`
- Upgraded `i18-embed` to version `0.16.0`
- Upgraded `i18-embed-fl` to version `0.10.0`
- Upgraded `quick-xml` to version `0.38.0`: this fixes extra whitespace generated by formatted XML.

## [0.8.6] 2025-06-21
[Sixteenth milestone](https://github.com/mrtryhard/qt-ts-tools/milestone/16).
...
## [0.8.5] 2025-05-09
[Fifteenth milestone](https://github.com/mrtryhard/qt-ts-tools/milestone/15).
This release is a maintenance release and introduces an upgrade of dependencies
...
## [0.8.4] 2025-04-04
[Fourteenth milestone](https://github.com/mrtryhard/qt-ts-tools/milestone/14).
This release is a maintenance release and introduces an upgrade of dependencies
